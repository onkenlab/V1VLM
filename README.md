...
Set up a data directory for the digital twin as described at
[ViV1T](https://github.com/bryanlimy/ViV1T-closed-loop). Then create a
Python 3.13 environment and install the required packages:
```
...
The following report was generated by the model. As context, we provided the
introduction from the paper "[Movie-trained transformer reveals novel response properties to dynamic stimuli in mouse visual cortex](https://www.biorxiv.org/content/10.1101/2025.09.16.676524)".
